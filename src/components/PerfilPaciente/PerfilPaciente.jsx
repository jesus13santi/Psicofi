        ...
        <div className={`${styles.fondorosa} ${styles.bordecontenedor}`}>
            ...
            <form>
                ...
                <div>
                    ...
                    <div className={styles.campo}><input className={styles.entrada} type="date" id="fecha de nacimiento" value = {birthday}></input></div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className={styles.campo}><input className={styles.entrada} type="text" id="telefono" value ={phone}></input></div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className={`${styles.campo} ${styles.lineagruesa}`}><textarea className={styles.entrada} id="biografia" value ={biography}/></div>
                </div>
                <div className= {styles.subtitulo}>
                    <label>Condiciones a tratar</label>
                </div>
                <div className = {styles.texto}>
                    <label>Marque a continuación las opciones que coincidan con sus problemas</label>
                </div>
